    ...
    <div class="rider-hall">
      ...
      <template #header>
        <div class="card-header">
          <span>接单大厅</span>
          <el-button type="primary" :icon="Refresh" @click="loadOrders" :loading="loading">刷新</el-button>
        </div>
      </template>
      <el-table :data="orderList" border v-loading="loading">
        ...
        <el-table-column prop="packageSize.sizeName" label="包裹规格" width="120" />
...
import { Box, User, Refresh } from '@element-plus/icons-vue'
import { getOrders, acceptOrder } from '@/api'

const userStore = useUserStore()
const activeIndex = ref('/rider/hall')
